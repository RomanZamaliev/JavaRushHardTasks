...
public class Util {
    ...
    public static List<Jeans> getAllJeans() {
        ...
        class Levis extends AbstractJeans{
            public Company company = Company.Levis;
            @Override
            public String getTM() {
        ...
        class Denim extends AbstractJeans{
            public Company company = Company.Denim;

            public Denim(int id, int length, int size, double price) {
                super(id, length, size, price);
                super.company = Company.Denim;
            }
        ...
        for (Object[] obj : getJeansArray()) {
            ...
            if (Company.Levis == company) {
                ...
                jeans = new AbstractJeans(id, length, size, price) {
                    ...
                    public Company company = (Company) obj[1];
                    {
                        super.company = this.company;
                    }
                    @Override
                    public String getTM() {
                        return company.fullName;
